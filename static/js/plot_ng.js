...
const predictionCommentary = ["US Natural Gas Price and Production Prediction with scikit-learn models in Python. <br>LinearRegression model was used to make predictions on data instances with an unknown expected outcome. The simple linear regression predicts US Natural Gas form an historical gas price and production.<br> A negative wieght coefficient suggests that as the independent variable increases, the dependent variable tends to decrease. The coefficient value signifies how much the mean of the dependent variable changes given a one-unit shift in the independent variable while holding other variables in the model constant. <br>The wieght coefficicients from the prediction show a negative value implying that as the production of Natural Gas increases the price decrease.<br> The model predicts a minimum price of $1.71 and a maximum price of $5.88 for Natural Gas at minimum production of 1645705 and maximum production of 2542913.US Natural Gas Price and Production Prediction with scikit-learn models in Python.",
"","",
""]
